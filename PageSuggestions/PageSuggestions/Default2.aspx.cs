...
namespace PageSuggestions
{
    public partial class _Default : Page
    {
        ...
        {            
            int selectedValue = RadioButtonList1.SelectedIndex;            
        ...
        protected void enviar_Click(object sender, EventArgs e)
        {
            ...
            mm.Body = "msj";//BootstrapTextBox1.Text; //"Msj del correo"
            mm.IsBodyHtml = true;
        ...
        protected void BootstrapTextBox1_TextChanged(object sender, EventArgs e)
        {
